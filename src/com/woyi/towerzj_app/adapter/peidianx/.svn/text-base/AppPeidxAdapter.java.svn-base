package com.woyi.towerzj_app.adapter.peidianx;
 ...
 */
public class AppPeidxAdapter extends BaseAdapter{
	...
	public AppPeidxAdapter(Context context, List<AppPowerBean> list) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup viewGroup) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.xml.item_pdx, null);
		...
		AppPowerBean info = list.get(position);
		if (info != null) {
