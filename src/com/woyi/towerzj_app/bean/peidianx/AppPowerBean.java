...
* 此类描述的是：配电箱
* @author: 罗然
* @version: 2015-7-20 上午9:52:38
* @ClassName: AppPowerBean 
* @项目： towerzj_app
* @包：com.woyi.towerzj_app.bean.peidianx
 */
public class AppPowerBean implements Serializable{
	private String 	id;			//流水号
	private String 	physicCode;	//编码2
	private String 	code;		//编码
	private String 	name;		//名称
	private String 	pp;			//品牌
	private Double 	rl;			//容量	DEC(12,2)
	private String 	ppCheck;	//品牌验
	private Double 	rlCheck;	//容量验	DEC(12,2)
